import { changeTaskStatusAC, changeTaskTitleAC, createTaskAC, deleteTaskAC, Task } from '@/features/model/tasks-reducer.ts'
...
import {
  ...
  deleteTodolistAC,
  FilterValues,
} from '@/features/model/todolist-reducers.ts'
